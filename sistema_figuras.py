...
def bubble_sort_recursivo(arr, n=None, key=lambda x: x, reverse=False, comparaciones=0, intercambios=0):
    if n is None:
        n = len(arr)
        arr = arr.copy()  # Copiar para no modificar la original
    ...
    return bubble_sort_recursivo(arr, n - 1, key, reverse, comparaciones, intercambios)
